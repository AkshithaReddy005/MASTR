...
*Note: The penalty analysis shows how different penalty values affect the model's performance. The route visualization demonstrates the optimized paths generated by the Q-learning agent.*
